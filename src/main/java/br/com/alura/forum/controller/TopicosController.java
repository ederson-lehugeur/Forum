...
public class TopicosController {
	...
	public Page<TopicoDto> findAll(
			...
			@RequestParam(defaultValue="12") Integer quantidade,
			@RequestParam(defaultValue="titulo") String ordenacao,
			@RequestParam(defaultValue="ASC") String direcao) {

		Pageable paginacao = PageRequest.of(pagina, quantidade, Direction.valueOf(direcao), ordenacao);
